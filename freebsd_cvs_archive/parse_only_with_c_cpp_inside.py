...
OUTPUT_DIR = "./freebsd_output_code_only"
...
# Only keep C / C++ files
# -----------------------------
VALID_EXT = (".c,v", ".h,v", ".cpp,v", ".cc,v", ".hpp,v")
...
# -----------------------------
# Optional: ensure it's code-like
# -----------------------------
def looks_like_c_code(text):
    keywords = [
        "#include", "int ", "void ", "struct ",
        "return", "{", "}", ";"
    ]
...
print("Total C/C++ CVS files:", len(v_files))
